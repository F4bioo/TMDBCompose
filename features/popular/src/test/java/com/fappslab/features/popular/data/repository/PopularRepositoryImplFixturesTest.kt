...
internal const val POPULAR_SUCCESS_RESPONSE = "popular_success.json"
internal const val POPULAR_FAILURE_RESPONSE = "popular_failure.json"
...
internal object ResponseFactory {
    private val movieResponse = readFromJSONToModel<MovieResponse>(POPULAR_SUCCESS_RESPONSE)
